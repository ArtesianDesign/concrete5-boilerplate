...
//$grid_class = 'col-sm-' . 12 / $top_level_total . ' ';
$grid_class = 'col-sm-2 col-lg-1 ';

//*** Step 2 of 2: Output menu HTML ***/
echo '<ul class="nav navbar-nav navbar-footer row">'; //opens the top-level menu

foreach ($navItems as $ni) {
  if ($ni->level == 1) {
    echo '<li class="' . $grid_class . $ni->classes . '">'; //opens a nav item
  } else {
